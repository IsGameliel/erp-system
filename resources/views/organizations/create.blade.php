<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Create organization</h2>
        </div>
    </x-slot>

    <form action="{{ route('owner.organizations.store') }}" class="page-panel space-y-6" method="POST">
        @csrf

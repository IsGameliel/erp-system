...
<div x-data="{ mobileMenuOpen: false }" @keydown.escape.window="mobileMenuOpen = false" class="relative border-b border-slate-200/80 bg-white/90 backdrop-blur lg:contents">
